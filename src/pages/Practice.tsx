                        ...
                        {games.length === 0 ? (
                            ...
                            <>
                                <div className='flex flex-col gap-4 self-center px-4'>
                                    <Button
                                        onClick={() => checkAnswer()}
                                        buttonStyle={notification.type === "success" || notification.type === "error" ? notification.type : "primary"}
                                    >
                                    ...
                                    <div className='flex flex-col items-center justify-between'>
                                        <label className='text-xs font-semibold' htmlFor='countdown'>
                                ...
                                <div className='flex flex-col gap-6'>
                                    <BoardEditor color={orientation === "w" ? "b" : "w"} pieceColor={pieceColor} setPieceColor={setPieceColor} />
                                    <Chessboard
                                    ...
                                    />
                                    <BoardEditor color={orientation === "w" ? "w" : "b"} pieceColor={pieceColor} setPieceColor={setPieceColor} />
                                </div>
