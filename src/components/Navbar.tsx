...
import { faBars, faChessQueen, faSun, faMoon } from "@fortawesome/free-solid-svg-icons";
        ...
        <>
            <nav className='relative flex items-center content-center justify-between bg-blue-500'>
                ...
                sm:pb-0`}
                    style={{ top: "100%" }}
                >
                    <Button customUtils='text-blue-200 hover:text-white mr-4' onClick={() => changeTheme()}>
