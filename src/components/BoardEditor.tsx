    ...
    >
      ...
      <div
        className={`flex items-center justify-center ${
          piece === "King" && pieceColor === color ? "bg-blue-500" : null
        }`}
        style={{ height: "70px", width: "70px" }}
        onClick={selectPiece}
        data-piece="King"
      ...
      <div
        className={`flex items-center justify-center ${
          piece === "Queen" && pieceColor === color ? "bg-blue-500" : null
        }`}
        style={{ height: "70px", width: "70px" }}
        onClick={selectPiece}
        data-piece="Queen"
      ...
      <div
        className={`flex items-center justify-center ${
          piece === "Bishop" && pieceColor === color ? "bg-blue-500" : null
        }`}
        style={{ height: "70px", width: "70px" }}
        onClick={selectPiece}
        data-piece="Bishop"
      ...
      <div
        className={`flex items-center justify-center ${
          piece === "Knight" && pieceColor === color ? "bg-blue-500" : null
        }`}
        style={{ height: "70px", width: "70px" }}
        onClick={selectPiece}
        data-piece="Knight"
      ...
      <div
        className={`flex items-center justify-center ${
          piece === "Rook" && pieceColor === color ? "bg-blue-500" : null
        }`}
        style={{ height: "70px", width: "70px" }}
        onClick={selectPiece}
        data-piece="Rook"
      ...
      <div
        className={`flex items-center justify-center ${
          piece === "Pawn" && pieceColor === color ? "bg-blue-500" : null
        }`}
        style={{ height: "70px", width: "70px" }}
        onClick={selectPiece}
        data-piece="Pawn"
