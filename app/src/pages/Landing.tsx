        ...
        <MainContent>
            ...
            <div className='flex flex-col items-start justify-center w-7/12'>
                <p className='leading-relaxed'>
                    ...
                    The practice page of the site displays a chess position that may arise in a human game and remains on screen for 5 seconds.
                    After the position is cleared from the screen, you have to try to correctly place as many pieces on the board that you can remember from the given position.
                    If you get it right, move onto the next position.
            ...
            <div className='flex flex-col items-start justify-center w-7/12'>
                <p className='leading-relaxed'>
                    ...
                    Recognition is one of the core requirements of what makes someone a master of a particular skill.
                    This is more deeply explained in Veritasium's video essay on <a className='text-blue-500 underline hover:text-blue-300' href='https://www.youtube.com/watch?v=5eW6Eagr9XA'>mastering skills</a>, and how it takes more than just 10,000 (10k) hours.<br/>
                    In the video, Derek brings up a study that found a major difference between players of differing skill levels is how many chess pieces they can recall in a 5 second time frame given a position from a human game.
